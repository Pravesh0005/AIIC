...
fun lightColors() = AIICColors(
    ...
    primaryMuted = Color(0xFFC7D2FE),
    primaryContainer = Color(0xFFE0E7FF),
    secondary = Color(0xFF0D9488),
    secondaryVariant = Color(0xFF0F766E),
    secondaryMuted = Color(0xFFCCFBF1),
    accent = Color(0xFF7C3AED),
    accentVariant = Color(0xFF6D28D9),
    accentMuted = Color(0xFFEDE9FE),
    tertiary = Color(0xFF94A3B8),
    tertiaryMuted = Color(0xFFCBD5E1),
    warning = Color(0xFFD97706),
    warningMuted = Color(0xFFFDE68A),
    error = Color(0xFFDC2626),
    errorMuted = Color(0xFFFECACA),
    success = Color(0xFF059669),
    successMuted = Color(0xFFA7F3D0),
    ...
    borderFocused = Color(0xFF4F46E5),
    borderSubtle = Color(0xFFF1F5F9),
    shimmer = Color(0xFFE2E8F0),
    shimmerHighlight = Color(0xFFF1F5F9),
    gradientPrimaryStart = Color(0xFF8B5CF6),
    gradientPrimaryEnd = Color(0xFF6366F1),
    gradientSecondaryStart = Color(0xFF14B8A6),
    gradientSecondaryEnd = Color(0xFF0D9488),
    ...
    navBarSelected = Color(0xFF0F172A),
